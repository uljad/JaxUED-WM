...
from jaxued.environments.world_models.gymnax.cartpole import Level, make_level_generator, CartPole
...
def main(config=None, project="JAXUED_TEST"):
    ...
    env = CartPole(config["model_paths"])
    eval_env = env
    sample_random_level = make_level_generator(env.num_world_models)
